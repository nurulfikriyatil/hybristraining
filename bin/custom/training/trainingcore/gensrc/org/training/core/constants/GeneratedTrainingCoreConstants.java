 ...
 * --- Generated at Nov 20, 2022, 10:03:42 AM                   ---
 * ----------------------------------------------------------------
 */
...
public class GeneratedTrainingCoreConstants
{
	...
	public static class TC
	{
		...
		public static final String DISTRICT = "District".intern();
		public static final String ELECTRONICSCOLORVARIANTPRODUCT = "ElectronicsColorVariantProduct".intern();
		public static final String GENREENUM = "GenreEnum".intern();
		public static final String MOBIL = "Mobil".intern();
		public static final String MOBILSPORT = "MobilSport".intern();
		public static final String MOBILSPY = "MobilSpy".intern();
		public static final String PROVINCE = "Province".intern();
		public static final String PUSO = "Puso".intern();
	...
	public static class Enumerations
	{
		...
		{
			public static final String SCIENCE = "SCIENCE".intern();
			public static final String FICTION = "FICTION".intern();
			public static final String HORROR = "HORROR".intern();
			public static final String HISTORY = "HISTORY".intern();
			public static final String RELIGION = "RELIGION".intern();
		}
	...
	{
		public static final String CITY2DISTRICT = "City2District".intern();
		public static final String PROVINCE2CITY = "Province2City".intern();
		public static final String STUDENT2BOOK = "Student2Book".intern();
		public static final String SUPPLIER2TRAININGVARIANTPRODUCTRELATION = "Supplier2TrainingVariantProductRelation".intern();
	}
