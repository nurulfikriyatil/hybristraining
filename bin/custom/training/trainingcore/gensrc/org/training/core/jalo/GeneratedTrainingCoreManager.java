 ...
 * --- Generated at Nov 20, 2022, 8:12:34 AM                    ---
 * ----------------------------------------------------------------
 */
...
import org.training.core.jalo.District;
import org.training.core.jalo.ElectronicsColorVariantProduct;
import org.training.core.jalo.Mobil;
import org.training.core.jalo.MobilSport;
import org.training.core.jalo.MobilSpy;
import org.training.core.jalo.Province;
import org.training.core.jalo.Puso;
...
public abstract class GeneratedTrainingCoreManager extends Extension
{
	...
	public District createDistrict(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.DISTRICT );
	...
	public Mobil createMobil(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.MOBIL );
			return (Mobil)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating Mobil : "+e.getMessage(), 0 );
		}
	}
	
	public Mobil createMobil(final Map attributeValues)
	{
		return createMobil( getSession().getSessionContext(), attributeValues );
	}
	
	public MobilSport createMobilSport(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.MOBILSPORT );
			return (MobilSport)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating MobilSport : "+e.getMessage(), 0 );
		}
	}
	
	public MobilSport createMobilSport(final Map attributeValues)
	{
		return createMobilSport( getSession().getSessionContext(), attributeValues );
	}
	
	public MobilSpy createMobilSpy(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.MOBILSPY );
			return (MobilSpy)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating MobilSpy : "+e.getMessage(), 0 );
		}
	}
	
	public MobilSpy createMobilSpy(final Map attributeValues)
	{
		return createMobilSpy( getSession().getSessionContext(), attributeValues );
	}
	...
	public Puso createPuso(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.PUSO );
			return (Puso)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating Puso : "+e.getMessage(), 0 );
		}
	}
	
	public Puso createPuso(final Map attributeValues)
	{
		return createPuso( getSession().getSessionContext(), attributeValues );
	}
